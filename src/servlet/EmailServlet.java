...
public class EmailServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		vCodeReceive = req.getParameter("vcode");//原来是vcode
		...
		/*
			HttpSession session = req.getSession();
		     //将数据存储到session中
		    session.setAttribute("emailV", vCode);
		    System.out.println("zzzzz"+vCode);
		    System.out.println("zzzzz"+session.getAttribute("emailV"));
		    req.getRequestDispatcher("../jsp/admin/regist.jsp").forward(req,resp);
		*/
			break;
		case "verify":
			mVerify();
